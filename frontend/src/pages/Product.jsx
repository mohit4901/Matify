    ...
    <div className='border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100'>
      ...
      <div className='flex gap-12 sm:gap-12 flex-col sm:flex-row'>
        ...
        <div className='flex-1'>
          ...
          <p className='mt-5 text-3xl font-medium'>{currency}{productData.price}  <span style={{ color: "red", text: "3xl" , fontWeight: "600" }}> <h3>30% OFF </h3></span> <span style={{ textDecoration: "line-through", color: "gray", text: "2xl" , marginRight: "8px" }}> ₹4999</span></p>
