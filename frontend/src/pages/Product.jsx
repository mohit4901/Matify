    ...
    <div className='border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100'>
      ...
      <div className='flex gap-12 sm:gap-12 flex-col sm:flex-row'>
        ...
        <div className='flex-1'>
          ...
          <p className='mt-5 text-2xl font-medium'> <span style={{ text: "3rem" , fontWeight: "600" }}>{currency}{productData.price} </span> <span style={{ color: "red", text: "2rem" , fontWeight: "600" }}> 30% OFF </span> <span style={{ textDecoration: "line-through", color: "gray", text: "1rem" , marginRight: "8px" }}> ₹4999</span></p>
